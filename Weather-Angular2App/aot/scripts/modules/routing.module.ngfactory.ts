...
import * as import10 from '../components/pageNotFound.component.ngfactory';
...
import * as import14 from '../../../scripts/components/cityWeatherSectionRouter.component';
import * as import15 from '../../../scripts/components/pageNotFound.component';
...
class RoutingModuleInjector extends import0.NgModuleInjector<import1.RoutingModule> {
  ...
  constructor(parent:import8.Injector) {
    super(parent,[
      ...
      import10.PageNotFoundComponentNgFactory
    ]
    ,([] as any[]));
  }
  ...
  get _ROUTES_9():any[] {
      if ((this.__ROUTES_9 == null)) { (this.__ROUTES_9 = [[
        {
          path: 'weather-list',
          component: import14.CityWeatherSectionRouterComponent
        }
        ,
        {
          path: 'map',
        ...
        {
          path: '**',
          component: import15.PageNotFoundComponent
        }
  ...
  get _ROUTER_INITIALIZER_16():any {
    if ((this.__ROUTER_INITIALIZER_16 == null)) { (this.__ROUTER_INITIALIZER_16 = import2.initialRouterNavigation(this._Router_10,this.parent.get(import16.ApplicationRef),this._RouterPreloader_14,this._ROUTER_CONFIGURATION_3)); }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import22.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_17; }
