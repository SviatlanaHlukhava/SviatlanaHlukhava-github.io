...
export var View_TableFormComponent0 = (function (_super) {
    ...
    View_TableFormComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import21.TemplateRef) && (9 === requestNodeIndex))) {
            return this._TemplateRef_9_5;
        }
        if (((token === import23.NgFor) && (9 === requestNodeIndex))) {
            return this._NgFor_9_6.context;
        }
        if (((token === import24.SelectMultipleControlValueAccessor) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 10)))) {
            return this._SelectMultipleControlValueAccessor_7_3.context;
        }
        if (((token === import25.NG_VALUE_ACCESSOR) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 10)))) {
            return this._NG_VALUE_ACCESSOR_7_4;
        }
        if (((token === import26.FormControlName) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 10)))) {
            return this._FormControlName_7_5.context;
        }
        if (((token === import27.NgControl) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 10)))) {
            return this._NgControl_7_6;
        }
        if (((token === import28.NgControlStatus) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 10)))) {
            return this._NgControlStatus_7_7.context;
        }
        if (((token === import29.CheckboxControlValueAccessor) && (16 === requestNodeIndex))) {
        ...
        if (((token === import26.FormControlName) && (16 === requestNodeIndex))) {
        ...
        if (((token === import30.DefaultValueAccessor) && (25 === requestNodeIndex))) {
            return this._DefaultValueAccessor_25_3.context;
        }
        if (((token === import31.NumberValueAccessor) && (25 === requestNodeIndex))) {
            return this._NumberValueAccessor_25_4.context;
        }
        if (((token === import25.NG_VALUE_ACCESSOR) && (25 === requestNodeIndex))) {
        ...
        if (((token === import27.NgControl) && (25 === requestNodeIndex))) {
            return this._NgControl_25_7;
        }
        if (((token === import28.NgControlStatus) && (25 === requestNodeIndex))) {
            return this._NgControlStatus_25_8.context;
        }
        if (((token === import32.FormGroupDirective) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 30)))) {
            return this._FormGroupDirective_0_3.context;
        }
        if (((token === import33.ControlContainer) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 30)))) {
            return this._ControlContainer_0_4;
        }
        if (((token === import28.NgControlStatusGroup) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 30)))) {
    ...
    View_TableFormComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_53 = !this.context.form.valid;
...
var View_TableFormComponent1 = (function (_super) {
    ...
    View_TableFormComponent1.prototype.createInternal = function (rootSelector) {
        ...
        this._NgSelectOption_0_3 = new import34.Wrapper_NgSelectOption(new import20.ElementRef(this._el_0), this.renderer, null);
        this._NgSelectMultipleOption_0_4 = new import13.Wrapper_NgSelectMultipleOption(new import20.ElementRef(this._el_0), this.renderer, this.parentView._SelectMultipleControlValueAccessor_7_3.context);
    ...
    View_TableFormComponent1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import35.NgSelectOption) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
