...
export var View_AppComponent0 = (function (_super) {
    ...
    View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_6 = import3.createRenderElement(this.renderer, parentRenderNode, 'router-outlet', new import3.InlineArray2(2, 'name', 'myCityWeather'), null);
        this._vc_6 = new import19.ViewContainer(6, null, this, this._el_6);
    ...
    View_AppComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import26.RouterOutlet) && (4 === requestNodeIndex))) {
            return this._RouterOutlet_4_5.context;
        }
        if (((token === import26.RouterOutlet) && (6 === requestNodeIndex))) {
            return this._RouterOutlet_6_5.context;
        }
        if (((token === import21.FooterComponent) && (8 === requestNodeIndex))) {
