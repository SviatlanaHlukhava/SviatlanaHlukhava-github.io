...
var View_PageNotFoundComponent_Host0 = (function (_super) {
    ...
    View_PageNotFoundComponent_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer, 'page-not-found', import3.EMPTY_INLINE_ARRAY, rootSelector, null);
    ...
    View_PageNotFoundComponent_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        if (this._PageNotFoundComponent_0_3.ngDoCheck(this, this._el_0, throwOnChange)) {
...
export var PageNotFoundComponentNgFactory = new import7.ComponentFactory('page-not-found', View_PageNotFoundComponent_Host0, import0.PageNotFoundComponent);
var styles_PageNotFoundComponent = [import8.styles];
var renderType_PageNotFoundComponent = import3.createRenderComponentType('', 0, import4.ViewEncapsulation.Emulated, styles_PageNotFoundComponent, {});
export var View_PageNotFoundComponent0 = (function (_super) {
    ...
    function View_PageNotFoundComponent0(viewUtils, parentView, parentIndex, parentElement) {
        _super.call(this, View_PageNotFoundComponent0, renderType_PageNotFoundComponent, import5.ViewType.COMPONENT, viewUtils, parentView, parentIndex, parentElement, import6.ChangeDetectorStatus.CheckOnce);
    }
    View_PageNotFoundComponent0.prototype.createInternal = function (rootSelector) {
        var parentRenderNode = this.renderer.createViewRoot(this.parentElement);
        this._el_0 = import3.createRenderElement(this.renderer, parentRenderNode, 'div', new import3.InlineArray2(2, 'class', 'not-found'), null);
